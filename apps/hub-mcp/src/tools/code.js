 ...
 */
export function registerCodeTools(server, env) {
    // code.search — query codebase concepts and workflows
    server.tool('cortex.code.search', 'Query the codebase for architecture concepts, execution flows, and file matches using GitNexus hybrid vector/AST search. Use projectId to scope to a specific project.', {
    ...
    server.tool('cortex.code.impact', 'Analyze the blast radius of changing a specific symbol (function, class, file) to verify downstream impact before making edits.', {
